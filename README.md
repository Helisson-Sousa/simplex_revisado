...
Este projeto tem como objetivo a implementação do **método Simplex Revisado** utilizando Python, com recursos adicionais para análise econômica e sensibilidade das soluções de Programação Linear.
